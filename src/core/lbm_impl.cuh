...
// __global__
// inline void update_avg_mag(float* rho, float* u, float* pi_mag, MomentInfo* moment_info) {
...
// inline __global__ void uncorrected_macroscopics_kernel(float* f, float* rho, float* u, float* force, float* pi_mag) {
//     int x = blockIdx.x * blockDim.x + threadIdx.x;
//     int y = blockIdx.y * blockDim.y + threadIdx.y;
...
// inline __global__ void correct_macroscopics_kernel(float* f, float* rho, float* u, float* force, float* d_pi_mag) {
//     int x = blockIdx.x * blockDim.x + threadIdx.x;
//     int y = blockIdx.y * blockDim.y + threadIdx.y;
